...
CREATE TABLE mantenimiento(
    ...
    fecha_ultima 	DATE,
    fecha_proxima 	DATE,
    gasto_combustible 	NUMBER(8,2),
    refaccion 	NUMBER(8,2),
    costo_total 	NUMBER(8,2)
);

CREATE TABLE coche(
    matricula 	VARCHAR2(9) PRIMARY KEY,
    madelo 		VARCHAR2(20),
    marca 		VARCHAR2(15),
    ocupantes 	NUMBER,
    precioxdia 	NUMBER(8,2),
...
INSERT INTO alquiler VALUES ('alqui005','18/05/2021','20/05/2021','4785','CHAP0997');
...
----empleado
ALTER TABLE empleado ADD puesto2 VARCHAR2(15);
UPDATE empleado SET puesto2=puesto;
----garage
ALTER TABLE garage ADD capacidad2 NUMBER;
